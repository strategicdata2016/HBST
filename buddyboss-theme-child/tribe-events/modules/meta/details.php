...
<div class="tribe-events-meta-group tribe-events-meta-group-details">
	...
	<a style="color:#FFF; background-color:#ff7004; padding:10px 20px; margin: 10px 0;" target="_blank" href="<?php echo tribe_get_event_meta( $post->ID, '_EventURL', true ); ?>">Register Now</a>
