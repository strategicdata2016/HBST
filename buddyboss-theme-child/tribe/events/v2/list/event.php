...
<!-- Add CTA Event Link Button --> 				
				<br>
<a class="tribe-common-c-btn-border tribe-events-c-subscribe-dropdown__button" target="_blank" href="<?php echo tribe_get_event_meta( $post->ID, '_EventURL', true ); ?>">Register Now</a>	<br>
<!-- End of Add CTA Event Link Button --> 				
			</div>
		</article>
	</div>
